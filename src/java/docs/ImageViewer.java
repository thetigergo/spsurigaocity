 ...
 * @author felix
 */
@javax.servlet.annotation.WebServlet(name = "ImageViewer", urlPatterns = {"/consol/imageViewer.html", "/imageViewer.html"})
public class ImageViewer extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
        ...
        Long oid = Long.parseLong(request.getParameter("myOID"));
        ...
        try {
            jdbc = database.DataSource.getConnect();
